...
/**
 * Classe qui permet de crée la fenêtre contenant les concepts scientifiques
 * utilisés pour la création de cette application
 * 
 * @author Andy Lam
 *
 */
public class ConceptScientifique extends JFrame {
	...
	/**
	 * Crée la fenêtre contenant les concepts scientifiques utilisés durant la

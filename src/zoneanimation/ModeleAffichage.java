...
/**
 * Un objet ModeleAffichage permet de mémoriser un ensemble de valeurs pour
 * passer du monde réel vers un composant de dessin dont les coordonnées sont en
 * pixels. On peut interroger l'objet pour connaitre la matrice de
 * transformation, le nombre de pixels par unité, les dimensions dans le monde
 * réel, etc.
 * 
...
public class ModeleAffichage {
	...
	/**
	 * Permet de créer un objet ModelAffichage, pouvant mémoriser la matrice (et
	 * autres valeurs) de transformation pour passer du monde vers le composant. les
	 * dimensions du monde réel sont passées en paramètre (largeur et hauteur). Si
	 * le rapport entre les dimensions en pixels n'est pas identique au rapport
	 * entre les dimensions réelles, il y aura distortion.
	 * 
	 * @param largPixels
	 *            La largeur du composant, en pixels
	 * @param hautPixels
	 *            La hauteur du composant, en pixels
	 * @param xOrigUnitesReelle
	 *            L'origine en x de la portion du monde réel que l'on veut montrer
	 * @param yOrigUnitesReelle
	 *            L'origine en y de la portion du monde réel que l'on veut montrer
	 * @param largUnitesReelles
	 *            La largeur considérée dans le monde, en unité réelles
	 * @param hautUnitesReelles
	 *            La hauteur considérée dans le monde, en unité réelles
	 * @param typeLargeur
	 *            Booléen qui vaut vrai si la dimension fournie est la largeur du
	 *            monde, vaut faux si la dimension fournie est la hauteur du monde
	 */
	public ModeleAffichage(double largPixels, double hautPixels, double xOrigUnitesReelle, double yOrigUnitesReelle,
			double largUnitesReelles, double hautUnitesReelles) {
	 ...
	 * autres valeurs) de transformation pour passer du monde vers le composant. Une
	 * des dimensions du monde réel est passée en paramètre (largeur ou hauteur).
	 ...
	 * @param yOrigUnitesReelle
	 *            L'origine en y de la portion du monde réel que l'on veut montrer
	 * @param dimensionEnUnitesReelles
	 *            La dimensions considérée dans le monde, en unité réelles (il peut
	 *            s'agir d'une largeur ou d'une hauteur, dépendant du dernier
	 *            paramètre)
	 * @param typeLargeur
	 *            Booléen qui vaut vrai si la dimension fournie est la largeur du
	 *            monde, vaut faux si la dimension fournie est la hauteur du monde
	 */
	public ModeleAffichage(double largPixels, double hautPixels, double xOrigUnitesReelle, double yOrigUnitesReelle,
			double dimensionEnUnitesReelles, boolean typeLargeur) {
		...
		if (typeLargeur) {
			...
			// le parametre "dimensionEnUnitesReelles" ne represente PAS la largeur, il
			// représente plutôt la HAUTEUR voulue
		...
		// pour ce constructeur il n'y a pas de distortion, donc les deux valeurs
		// suivantes seront identiques
		this.pixelsParUniteX = largPixels / largUnitesReelles;
		this.pixelsParUniteY = hautPixels / hautUnitesReelles;
	...
	/**
	 * Création d'un objet ModeleAffichage où la dimension passée en paramètre est
	 * forcément la largeur du monde
	 * 
	 * @param largPixels
	 *            La largeur du composant, en pixels
	 * @param hautPixels
	 ...
	 */
	public ModeleAffichage(double largPixels, double hautPixels, double xOrigUnitesReelle, double yOrigUnitesReelle,
			double dimensionEnUnitesReelles) {
	 ...
	 * @param typeLargeur
	 *            Booléen qui vaut vrai si la dimension fournie est la largeur du
	 *            monde, qui vaut faux si la dimension fournie est la hauteur du
	 *            monde
	 */
	...
	/**
	 * Création d'un objet ModeleAffichage où l'origine du monde réel est à 0,0, et
	 * où la dimension passée en paramètre est forcément la largeur du monde
	 * 
	 * @param largPixels
	 *            La largeur du composant, en pixels
	 * @param hautPixels

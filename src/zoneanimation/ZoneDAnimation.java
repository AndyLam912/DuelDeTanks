...
public class ZoneDAnimation extends JPanel implements Runnable {
	...
	public void affichageVecteurs(Graphics2D g2d) {
		if (afficherVecteurs) {
			...
			if (explosionChamp) {
				// dessin du vecteur, on prend la force électrique divisée par 5 pour plus de
				// lisibilité
	...
	// Andy Lam
	/**
	 * Méthode qui permet de voir si le projectile est visible dans la zone d'animation ou en haut de la zone d'animation.
	 * 
	 * 
	...
	public void explosionObus() {
		...
		// Permet de changer la position du char si l'obus a déformer le sol sous un des
		// chars
	...
	// Andy Lam
	/**
	 * Methode qui permet de faire tous les effets lorsqu'une grenade électrique
	 * explose
	 */
	...
	// par léo-paul lapointe
	/**
	 * permet de verifier si il y a un gagnant et de lever l'événement qui affichera
	...
	// par léo-paul lapointe
	/**
	 * ajoute les écouteurs qui change la couleur des fleches
	 * 
	 * @param objEcout
	 */
	...
	// par léo-paul lapointe
	/**
	 * ajoute les ecouteurs qui sont reliés aux tours
	 * 
	 * @param objEcout
	 */
	...
	// par léo-paul lapointe
	/**
	 * permet de lever quand il faut activer les composants d'entrée
	 */
	...
	// par léo-paul lapointe
	/**
	 * permet de lever quand un nouveau terrain est dessiné
	 */
	 ...
	 * 
	 * @param ventActive
	 *            vrai si on veut que le projectile soit affecté par le vent
	 */
	...
	// par léo-paul lapointe
	/**
	 * permet de modifier la charge du champ généré par la grenade
	 * 
	 * @param chargeChamp
	 *            la nouvelle charge
	 */
	...
	// Andy Lam
	/**
	 * Méthode qui permet de retourner le champ gravitationnel de la zone
	 * d'animation
	 * 
	...
	// Andy Lam
	/**
	 * Methode qui permet de retourner la charge de la grenade électrique par défaut
	 * 
	 * @return la charge de la grenade électrique par défaut
	 */
